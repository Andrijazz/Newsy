...
#include "../../../NewsClassifier/app/spinnerwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SpinnerWidget_t, stringdata) + ofs \
...
const QMetaObject SpinnerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SpinnerWidget.data,
      qt_meta_data_SpinnerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpinnerWidget.stringdata))
        return static_cast<void*>(const_cast< SpinnerWidget*>(this));
